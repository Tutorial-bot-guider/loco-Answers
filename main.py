...
"643316408511365121", #loco testing
]
...
class Bot(discord.Client):
    ...
    def __init__(self, answer_scores):
        ...
        # embed creation
        self.embed=discord.Embed(title="Loco")
        ...
        self.embed.set_footer(text='꧁༒۝ŘĮŤĘ§H۝༒꧂#6898')
    ...
    async def on_ready(self):
        ...
        await self.change_presence(activity=discord.Game(name='with Just for fun | -lo'))
